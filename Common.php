...
//Connection Settings @0-01497E11
$CCConnectionSettings = array (
    "candat" => array(
        "Type" => "MySQL",
        "DBLib" => "MySQL",
        "Database" => "362758_candatdata",
        "Host" => "mysql51-118.wc1.ord1.stabletransit.com",
        "Port" => "",
        "User" => "362758_candat",
        "Password" => "Gjgrandi58",
        "Persistent" => true,
...
//Initialize Common Variables @0-305F1B55
...
$DefaultDateFormat = array("yyyy", "-", "mm", "-", "dd", " ", "HH", ":", "nn", ":", "ss");

$MainPage = new clsMainPage();
//End Initialize Common Variables

//candat Connection Class @-A89C70A9
class clsDBcandat extends DB_Adapter
{
    function clsDBcandat()
    {
        $this->Initialize();
    }
    ...
    function Initialize()
    {
        ...
        $this->SetProvider($CCConnectionSettings["candat"]);
        parent::Initialize();
...
//End candat Connection Class

//Initialize CacheManager @0-3392417D
$CCSCacheManager = new clsCustomCacheManager();
$MainPage->CachePage = & $CachePage;
$MainPage->CacheAction = & $CacheAction;
$MainPage->CacheParameters = & $CacheAction;
$MainPage->CacheKey = & $CacheKey;
$MainPage->CacheObject = & $CacheObject;
//End Initialize CacheManager
